...
"[12:55:23][server]: moved client 0 to team 0"
"[18:29:29][econ]: client accepted. cid=1 addr=XXX.XXX.XXX.XXX:33914'"
...
exports.EVENT_HANDLERS = {
    ...
    console: [
        {
            ...
            regex: new RegExp(/transaction_begin (?<id>.*)/),
            transforms: DEFAULT_TRANSFORMS,
        },
        {
            name: "transaction_end",
            regex: new RegExp(/transaction_end (?<id>.*)/),
            transforms: DEFAULT_TRANSFORMS,
        },
        {
            name: "value",
            regex: new RegExp(/Value: (?<data>.*)/),
        },
    ],
    register: [
        {
    ...
    server: [
        ...
        {
            //tw:TwEconClient UNKNOWN LINE: "[12:15:24][server]: cid=1 cmd='status'" +49ms
            name: "client_command",
